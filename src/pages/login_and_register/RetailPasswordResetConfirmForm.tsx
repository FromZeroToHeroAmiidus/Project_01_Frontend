...
import RetailPasswordResetConfirm from "./components/RetailPasswordResetConfirm";

const RetailForgotPasswordForm: React.FC = () => {
  ...
  return (
    <div className="bg-background flex px-0 max-w-1440 mx-auto h-[1024px] justify-between">
      ...
      <div className="flex justify-center items-center">
        <RetailPasswordResetConfirm />
      </div>
    </div>
  );
};

export default RetailForgotPasswordForm;
